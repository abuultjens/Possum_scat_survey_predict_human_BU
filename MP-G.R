...
ARG1 = 1 # US
# toString(args[3])
ARG3 = "data/20210811_Extract4Nick.csv"
# toString(args[4])
ARG4 = "MP-G_US-1_PRESENCE_101-171_AB-DATA_MP-MP_MODEL.RDS"
# toString(args[5])
ARG5 = "MP-G_US-1_PRESENCE_101-171_AB-DATA_MP-G_MODEL.RDS"
# toString(args[6])
ARG6 = "MP-G_US-1_PRESENCE_101-171_AB-DATA_predictions_to_evaluate.csv"
# toString(args[7])
ARG7 = "MP-G_US-1_PRESENCE_101-171_AB-DATA_AUC.csv"
# toString(args[8])
ARG8 = "MP-G_US-1_PRESENCE_101-171_AB-DATA_stats.csv"
# toString(args[9])
ARG9 = "MP-G_US-1_PRESENCE_101-171_AB-DATA_matrix.csv"
# toString(args[10])
ARG10 = "MP-G_US-1_PRESENCE_101-171_AB-DATA_any.csv"
# toString(args[11])
ARG11 = "MP-G_US-1_PRESENCE_101-171_AB-DATA_pred_any.csv"
# toString(args[12])
ARG12 = "MP-G_US-1_PRESENCE_101-171_AB-DATA_"
# toString(args[13])
ARG13 = "MP-G_US-1_PRESENCE_101-171_AB-DATA_ranking.csv"


# ARG1 = as.integer(args[1])
# ARG3 = toString(args[3])
# ARG4 = toString(args[4])
# ARG5 = toString(args[5])
# ARG6 = toString(args[6])
# ARG7 = toString(args[7])
# ARG8 = toString(args[8])
# ARG9 = toString(args[9])
# ARG10 = toString(args[10])
# ARG11 = toString(args[11])
# ARG12 = toString(args[12])
# ARG13 = toString(args[13])
